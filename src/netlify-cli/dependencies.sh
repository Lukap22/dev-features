...
# installing ghcr.io/devcontainers-contrib/features/npm-package:1.0.1
PACKAGE="netlify-cli" VERSION="$VERSION" featmake "ghcr.io/devcontainers-contrib/features/npm-package:1.0.1"
